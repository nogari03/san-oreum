...
public class E_p001DAOImpl implements E_p001DAO{
	...
	public int deleteUser(String userId) throws Exception {
		return sqlSession.delete("admin.mapper.e_p001.deleteUser",userId);
	}

	@Override //회원 정보 수정전 list 출력
	public List selectUpdateUserList(String userId) throws Exception {
		List upDateUserList=sqlSession.selectList("admin.mapper.e_p001.selectUpdateUserList",userId);
